...
class CadastroPageTattuador extends StatelessWidget {
  const CadastroPageTattuador({Key? key, required String title})
      : super(key: key);
                          ...
                          children: [
                            ...
                            TextField(
                              decoration: InputDecoration(
                                filled: true,
                                fillColor: Color.fromARGB(255, 212, 212, 208),
                                labelText: 'Endereço', // Campo Endereço
                                hintStyle: TextStyle(fontSize: 12),
                                border: OutlineInputBorder(
                                  borderRadius:
                                      BorderRadius.all(Radius.circular(8)),
                            ...
                            TextField(
                              decoration: InputDecoration(
                                filled: true,
                                fillColor: Color.fromARGB(255, 212, 212, 208),
                                labelText: 'Razão Social', // Campo Razão Social
                                hintStyle: TextStyle(fontSize: 12),
                                border: OutlineInputBorder(
                                  borderRadius:
                                      BorderRadius.all(Radius.circular(8)),
  ...
  cadastrocnpj({required String title}) {}
}
